...
class DatasetCreator:
    ...
    async def dump_all_messages(self, channel, url, ch):
        ...
        if url == "https://t.me/alexmakus":
            end = self.channels[url] - 3000
        elif url == "https://t.me/CicadaHere":
            end = self.channels[url] - 5000
        elif url == "https://t.me/spherechat":
            end = self.channels[url] - 190000
        elif url == "https://t.me/spherechatflood":
            end = self.channels[url] - 450000
        ...
        while i >= end:
            ...
            for message in all_messages:
                d = {}
                keys = ['channel_id','id','date', 'message', 'url', 'site_name', 'title', 'description']
